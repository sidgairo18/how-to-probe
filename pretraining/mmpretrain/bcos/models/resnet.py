...
# for mmpretrain change to BasicBlock(BaseModule) [also import BaseModule]
...
# here also use Bottleneck(BaseModule).
...
# convert this to BcosResNet(BcosUtilMixin, BaseBackbone)
# also note that the output of this should be B x C x 1 x 1 
# and not B x num_classes
