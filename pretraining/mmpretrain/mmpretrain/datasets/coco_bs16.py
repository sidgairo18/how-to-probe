...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root='/ptmp/sgairola/work/data/COCO2014',
        data_prefix=dict(img_path='train2014', ann_path=''),
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root='/ptmp/sgairola/work/data/COCO2014',                                        
        data_prefix=dict(img_path='val2014', ann_path=''),                                   
