...
class COCO_MULTILABEL(MultiLabelDataset):
    ...
    def __init__(self,
                 ...
                 data_prefix: Union[str, dict] = dict(
                     img_path='train2014', ann_path='annotations'),
                 ann_file: str = '',
    ...
    def load_data_list(self) -> List[dict]:
        ...
        """  # noqa: E501
        with get_local_path(osp.join(self.data_root, self.data_prefix['ann_path'], self.ann_file),
                            backend_args=None) as local_path:
        ...
        for img_id in img_ids:
            ...
            info = dict(
                    img_path=parsed_data_info['img_path'],
                    gt_label=parsed_data_info['labels'],
                    gt_label_difficult=parsed_data_info['labels_difficult']
                    )
    ...
    def parse_data_info(self, raw_data_info: dict) -> Union[dict, List[dict]]:
        ...
        instances = []
        labels = set() # get set of labels
        labels_difficult = set() # just for consistency with VOC
        for i, ann in enumerate(ann_info):
            ...
            labels.add(self.cat2label[ann['category_id']])
        ...
        data_info['labels'] = list(labels)
        data_info['labels_difficult'] = list(labels_difficult)
        return data_info
