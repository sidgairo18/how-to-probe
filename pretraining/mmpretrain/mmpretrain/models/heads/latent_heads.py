...
@MODELS.register_module()
class BcosLatentCrossCorrelationHead(BaseModule):
    """Head for latent feature cross correlation.
    ...
    def __init__(self,
        ...
        super().__init__(init_cfg=init_cfg)
        self.world_size = get_world_size()
        self.bn = norms.DetachableLayerNorm(in_channels, elementwise_affine=False)
        #self.bn = norms.BatchNormUncentered1d)(in_channels, affine=False)
        self.loss_module = MODELS.build(loss)
