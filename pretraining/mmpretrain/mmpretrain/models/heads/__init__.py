...
from .latent_heads import LatentCrossCorrelationHead, LatentPredictHead, BcosLatentCrossCorrelationHead
...
# bcos imports
from .bcos_linear_head import BcosLinearClsHead
from .bcos_linear_head_old import BcosLinearClsHeadOld
from .bcos_multi_label_linear_head import BcosMultiLabelLinearClsHead
from .multi_layer_linear_head import MultiLayerLinearClsHead
...
__all__ = [
    ...
    'DINOHead',
    'BcosLinearClsHead',
    'BcosLinearClsHeadOld',
    'BcosMultiLabelLinearClsHead',
    'MultiLayerLinearClsHead'
]
