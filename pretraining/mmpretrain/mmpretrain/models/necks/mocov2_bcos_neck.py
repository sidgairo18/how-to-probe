...
class MoCoV2BcosNeck(BaseModule):
    """The non-linear neck of MoCo v2 Bcos: Bcos_fc-Bcosfc.
    ...
    def __init__(self,
        ...
        '''
        self.mlp = nn.Sequential(
            BcosLinear(in_channels, hid_channels), # note no ReLU activation here for bcos
