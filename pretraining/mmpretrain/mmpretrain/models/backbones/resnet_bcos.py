...
from bcos.modules import StochasticDepth
...
# convert this to BcosResNet(BcosUtilMixin, BaseBackbone) also note that the output
# of this should be ([B x C x 1 x 1]) and not B x num_classes
@MODELS.register_module()
class BcosResNet(BcosUtilMixin, BaseBackbone):
    def __init__(
        self,
        ...
        **kwargs: Any,  # ignore rest
        ...
        super(BcosResNet, self).__init__(init_cfg=init_cfg)
    ...
    def init_weights(self):
        super(BcosResNet, self).init_weights()
