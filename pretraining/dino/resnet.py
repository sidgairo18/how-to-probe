...
def resnet101(*, weights: Optional[Any] = None, progress: bool = True, **kwargs: Any) -> ResNet:
...
def resnet152(*, weights: Optional[Any] = None, progress: bool = True, **kwargs: Any) -> ResNet:
